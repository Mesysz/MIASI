...
public class SendMessageTaskCandidateRejected implements JavaDelegate {

    Logger logger = LoggerFactory.getLogger(SendMessageTaskCandidateRejected.class);

    @Override
    public void execute(DelegateExecution delegateExecution) throws Exception {

        logger.info("SendMessageTaskCandidateRejected");
        ...
        try {
            ...
            message.setSubject("Informacje dotyczące rekruatcji");

            String content = "<h1>Niestety nie przeszedłeś rekrutacji.</h1>\n";
...
//            }
            ...
            content = content + "<h2> Dziękujemy za udział</h2>";
