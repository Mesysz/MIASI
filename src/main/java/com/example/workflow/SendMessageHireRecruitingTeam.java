...
public class SendMessageHireRecruitingTeam implements JavaDelegate {

    Logger logger = LoggerFactory.getLogger(SendMessageHireRecruitingTeam.class);
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        logger.info("SendMessageHireRecruitingTeam");
        ...
        try {
            ...
            message.setSubject("Niepowodzenie procesu rekrutacji");

            String content = "<h1>Proces rekruatacji zakończył się niepowodzeniem, sugrujemy zatrudnić zewnętrzną firme rekrutacyjną.</h1>\n";
